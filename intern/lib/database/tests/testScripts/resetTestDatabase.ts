...
export default async function resetTestDatabase() {
    try {
        ...
        await pool.query(`
            ...
            (456, 'Jane Smith', 0.85, 15.2, 8, 'Excellent', 1),
            (789, 'Bob Johnson', 0.62, 30.0, 3, 'Fair', 1),
            (987, 'Alice Williams', 0.92, 18.3, 6, 'Excellent', 1),
            (654, 'Charlie Brown', 0.78, 25.7, 4, 'Good', 1),
            (321, 'Eva Davis', 0.69, 22.1, 7, 'Fair', 1),
            (555, 'Sam Taylor', 0.88, 12.6, 9, 'Excellent', 1),
            (777, 'Olivia White', 0.71, 28.4, 2, 'Good', 1),
            (888, 'Michael Lee', 0.80, 16.8, 5, 'Fair', 1),
            (999, 'Sophia Harris', 0.95, 14.2, 8, 'Excellent', 3);
        `);
